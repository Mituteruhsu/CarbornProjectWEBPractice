...
# 🌿 碳排放目標管理系統 (Carbon Emission Target Management System)

本系統提供企業用戶管理並追蹤年度碳排放量、設定減碳目標，以及視覺化展示企業碳排放趨勢，協助企業邁向永續發展目標 (ESG)。

---

## 📘 專案簡介

本專案結合 **ASP.NET Core MVC**、**SQL Server** 與 **Chart.js**，建立企業可登入的碳排放管理平台，支援以下功能：

- 公司年度碳排放紀錄 (Scope 1 / 2 / 3)
- 排放趨勢圖與目標達成率分析
- 會員登入與權限管理
- 活動紀錄 (Activity Log)
- 行業別平均排放量比較
